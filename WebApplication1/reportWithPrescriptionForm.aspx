<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportWithPrescriptionForm.aspx.cs" Inherits="WebApplication1.reportWithPrescriptionForm" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            Medication:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dosage:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Refill:<br />
            <div style ="display:inline">
                <asp:TextBox ID ="medicationBox" runat="server" style="margin-right: 40px" BackColor="#CCCCCC" BorderColor="Black" BorderWidth="2px" Height="24px"></asp:TextBox>
                <asp:TextBox ID ="dosageBox" runat="server" style="margin-right: 40px" BackColor="#CCCCCC" BorderColor="Black" BorderWidth="2px" Height="24px"></asp:TextBox>
                <asp:TextBox ID ="refillBox" runat="server" style="margin-right: 40px" BackColor="#CCCCCC" BorderColor="Black" BorderWidth="2px" Height="24px"></asp:TextBox>
            
            </div>
            <br />
            <br />
            Instructions/Additional Details:<br />
            <asp:TextBox ID="instructionsBox" runat="server" BackColor="#CCCCCC" BorderWidth="2px" Height="57px" MaxLength="200" TextMode="MultiLine" Width="501px" ReadOnly="False"></asp:TextBox>
            <br />
            <br />
            <br />
            ...
            &nbsp;</div>
        <p>
            <asp:Button ID="returnBttn" runat="server" BackColor="#003300" BorderColor="#009933" BorderWidth="2px" Font-Bold="True" ForeColor="White" Height="37px" OnClick="returnBttn_Click" Text="submit" Width="251px" />
        </p>
    </form>
</body>
</html>
